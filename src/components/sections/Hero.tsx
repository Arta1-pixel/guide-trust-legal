...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary">
      ...
      <div className="absolute inset-0">
        <img src={heroImage} alt="Oficina del Corporativo Jurídico Sánchez" className="w-full h-full object-cover" />
      </div>

      {/* Dark Overlay for text readability */}
      <div className="absolute inset-0 bg-gradient-to-br from-navy-dark/90 via-primary/85 to-navy-light/80 opacity-80" />
      ...
      <div className="relative z-10 container-narrow section-padding text-center">
        ...
        ease: "easeOut"
          ...
          duration: 0.6
            ...
            <img src={logoImage} alt="Corporativo Jurídico Sánchez" className="w-28 h-28 md:w-36 md:h-36" />
          </motion.div>
